...
from common.base_class import  OffPolicyRLModel, SetVerbosity, TensorboardWriter
from common.vec_env_init import VecEnv
from common.math_util import safe_mean, unscale_action, scale_action
from common.schedules import get_schedule_fn
from common.buffers import ReplayBuffer
from baselines.sac.policies import SACPolicy
...
class SAC(OffPolicyRLModel):
    ...
    def __init__(self, policy, env, gamma=0.99, learning_rate=3e-4, buffer_size=100000,
                 learning_starts=100, train_freq=1, n_steps=64,
                 tau=0.005, ent_coef='auto', target_update_interval=1,
                 gradient_steps=64, target_entropy='auto', action_noise=None,
        ...
        with self.sess.as_default(), self.graph.as_default():
            ...
            for epoch_idx in range(int(n_epochs)):
                ...
                for i in range(nbatches):
                    ...
                    losses = self._train_step(epoch_idx * nbatches + i, None, current_lr)
                    print(f'Policy loss = {losses[0]}, value loss = {losses[3]}, entropy = {losses[4]}')
            ...
            for update in range(nupdates):
                ...
                for step in range(self.batch_size):
                    ...
                    if writer is not None:
                        ...
                        tf_util.total_episode_reward_logger(self.episode_reward, ep_reward, ep_done, writer, self.num_timesteps)
                ...
                if len(self.ep_info_buf) > 0 and len(self.ep_info_buf[0]) > 0:
                    logger.logkv('ep_rew_mean', safe_mean([ep_info['r'] for ep_info in self.ep_info_buf]))
